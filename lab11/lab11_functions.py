...
# Example 6, Function that return a Value
...
def collectnum():
    ...
    #validate the number
    while(not(1 <= n >=9)):
        n = float(input("Re-enter a number: "))
        return n
...
def ratio_hour(hour):
    try:
        ...
        print("ZERO EXECPTION")
        print("number can't be divided by zero")
        return 0
    except ValueError:
        print("VALUE EXECPTION")
...
#method to add miles into odometer
